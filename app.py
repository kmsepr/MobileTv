...
def generate_stream(url, high_quality=False):
    ...
    buffer = collections.deque(maxlen=800)  # store more chunks (~80s) for low-speed resilience
...
def index():
    ...
    <head>
      ...
      <style>
        body { font-family: sans-serif; font-size: 18px; padding: 10px; background-color: #ffffff; }
        a { display: block; padding: 10px; margin: 5px 0; color: #000000; background-color: #e0e0e0;
            text-decoration: none; border: 1px solid #aaa; font-weight: bold; }
        h3 { font-size: 20px; }
        .live-badge { background-color: red; color: white; font-size: 12px; padding: 2px 5px;
