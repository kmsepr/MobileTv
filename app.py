...
.card span { font-size:14px; color:#0f0; display:block; margin-bottom:5px; }
.hidden { display:none; }
a { color:#0ff; text-decoration:none; margin:0 4px; }
</style>
<script>
...
<div style="margin-top:15px;">
  ...
  <a href="/listen/{channel}" style="color:#f0f;">🎧 Audio</a>
</div>
</body>
</html>"""
    return html
